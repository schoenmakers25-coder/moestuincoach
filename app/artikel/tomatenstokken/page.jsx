...
const jsonLd = {
  ...
  step: [
    ...
    { '@type': 'HowToStep', name: 'Kies het juiste materiaal', text: 'Bamboe (1,8 tot 2 m) voor enkelvoudige planten, stalen kooi voor struikvormige rassen. Vermijd dunne bamboestokkjes: ze breken halverwege het seizoen.' },
        ...
        <div className="wrap">
          <div className="grid">
            ...
            <article className="prose">
              ...
              <ul>
                <li><b>Bamboe (1,8 tot 2 m)</b>: de standaard. Werkt goed voor enkelvoudige stengels. Let op: dunner dan 1 cm breekt halverwege augustus als de plant zwaar begint te worden. Koop de dikke.</li>
              ...
              <p>Minimaal 20 tot 30 cm de grond in, meer als de grond los is. De stok moet stabiel staan zonder te bewegen als je er zijdelings tegenaan duwt. Sla hem niet te snel in. Als je hem een paar centimeter per keer plaatst en luistert of je iets breekt (wortels), kun je bijsturen.</p>
            ...
            <aside className="aside" aria-label="Samenvatting">
              <div className="box">
                ...
                <div className="row"><span>Diepte stok</span><b>20 tot 30 cm</b></div>
