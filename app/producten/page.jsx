...
const CATEGORIES = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        tag: 'Zaden',
        why: 'Klaar in 22–28 dagen na zaaien — de snelste oogst in de moestuin. Ronde, knapperige vruchten met milde smaak. Uitstekend als tussengewas tussen langzamere planten als broccoli of kool.',
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        tip: 'Kies roestvrij staal of dikwandig kunststof — goedkope gieters barsten na één winter buiten.',
      },
      {
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        tip: 'Voeg compost toe in de herfst of vroege lente — geef het de tijd om in te werken voor het planten.',
      },
      {
        ...
        tip: 'Houd het medium vochtig maar niet nat — kokos houdt zoveel vocht vast dat overwater makkelijk is.',
      },
      {
    ...
    products: [
      {
        ...
        tip: 'Kies een breedte van maximaal 120 cm — dan kun je er van beide kanten bij zonder de grond in te lopen.',
      },
      {
